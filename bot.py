...
async def level(interaction: discord.Interaction):
    ...
    embed = discord.Embed(title=f"{interaction.user.display_name}'s Level", color=discord.Color.gold())
...
async def invites(interaction: discord.Interaction):
    ...
    embed = discord.Embed(title=f"{interaction.user.display_name}'s Invites", color=discord.Color.blurple())
    embed.set_thumbnail(url=interaction.user.display_avatar.url)
